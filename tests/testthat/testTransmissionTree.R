...
test_that("Single, discrete", {
  ...
  #
  expect_equal(get_state(tstateTable, "H-7", 7, tot_time), "A")
  expect_equal(get_state(tstateTable, "H-7", 9, tot_time), "C")
  expect_equal(get_state(tstateTable, "H-7", 10, tot_time), "C")
  expect_equal(get_state(tstateTable, "H-4", tot_time, tot_time), "C")
  # Node
