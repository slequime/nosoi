...
The output of a `nosoi` simulation is a `nosoiSim` class object that contains all the data generated during the simulation into the following slots:
...
The `nosoiSummary` is a turnkey solution that computes both the dynamics of the epidemic and $R_0$. Its only argument is your nosoi output object (of class `nosoiSim`):
