...
- `length.sim` [see general parameters](single-host-none.html#general-parameters) 
- `max.infected`  [see general parameters](single-host-none.html#general-parameters) 
- `init.individuals`  [see general parameters](single-host-none.html#general-parameters) 
- `init.structure`  [see general parameters](single-host-none.html#general-parameters) 
- `structure.matrix`
- `pExit` with `param.pExit`, `diff.pExit` and `timeDep.pExit` [see pExit](single-host-none.html#pexit-param-pexit-and-timedep-pexit) 
- `pMove` with `param.pMove`, `diff.pMove` and `timeDep.pMove`
- `timeContact` with `param.timeContact`, `diff.timeContact` and `timeDep.timeContact` [see timeContact](single-host-none.html#timecontact-param-timecontact-and-timedep-timecontact)
- `pTrans` with `param.pTrans`, `diff.pTrans` and `timeDep.pTrans` [see pTrans](single-host-none.html#ptrans-param-ptrans-and-timedep-ptrans)
- `prefix.host`
