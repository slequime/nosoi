...
The simulation will thus run until either the time limit or the maximum number of infected individuals is reached.
...
*Nosoi* gives as its output a `data.table` (a more efficient version of a `data.frame`) with the following structure:
