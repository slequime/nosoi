...
#GB: should 'takes' be replaced with 'requires'?
...
#GB: for my comments on all these descriptions, please have a look at my comments for the discrete tutorial
...
#GB: you need to explain the function (dnorm) and its parameters below
...
#GB: I've been using the singular "host's" rather than the plural "hosts' ", we should pick one and stick with it
