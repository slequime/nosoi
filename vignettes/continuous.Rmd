...
(3) current enviromental value `current.env.value` (optional);
...
To analyse and visualise your `nosoi` simulation output, you can have a look on [this page](example/viz.html).
