...
This tree is a bit messy, considering the number of transmission events and the overall size of this epidemic. We can also sub-sample it randomly. We will select here 150 individuals sampled at the time of their exit (either death or recovery):
