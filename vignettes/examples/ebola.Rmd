...
In this example, we aim to simulate an Ebola-like epidemic in Western Africa. We will use the distribution of the population in this region as the "environmental factor" to be included in our simulation (origin: [WorldPop](https://www.worldpop.org/)). The map will be the following (here represented on a log scale to show efficiently differences in distribution):
